            ...
            @foreach($prestamos as $prestamo)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/movimientos/prestamos/{{ $prestamo->id }}/modificar"
                            class="btn btn-warning btn-sm mb-1">Modificar</a>
                        <a href="/movimientos/prestamos/{{ $prestamo->id }}/eliminar" class="btn btn-danger btn-sm mb-1"
                            onclick="return confirm('¿Eliminar préstamo?')">Eliminar</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
